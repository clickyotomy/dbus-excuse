...
#define MAX_EXCUSES 466

#define DBUS_BOFH_NAME "dbus-excuse"
#define DBUS_BOFH_SERVICE "org.bofh"
#define DBUS_BOFH_OBJECT "/"
#define DBUS_BOFH_IFACE "org.bofh.loop"
#define DBUS_BOFH_EXC_FUNC "excuse"
#define DBUS_BOFH_TST_FUNC "test"
#define DBUS_BOFH_STP_FUNC "stop"
#define DBUS_ADDR_ENV "DBUS_SESSION_BUS_ADDRESS"
...
/*
 * Array of BOFH-style excuses.
 * Source: http://pages.cs.wisc.edu/~ballard/bofh/excuses.
 */
static char *excuses[MAX_EXCUSES] = {
    "Clock speed.",
    "Solar Flares.",
    ...
    "Police are examining all the Internet packets in the search for a "
    "narco-net-trafficker.",
    "We are currently trying a new concept of using a live mouse. "
    "Unfortunately, one has yet to survive being hooked up to the computer... "
    "Please bear with us.",
    ...
    "Micro-electronic Riemannian curved-space fault in write-only file system.",
    "Fractal radiation jamming the backbone.",
    "Routing problems on the neural net.",
    "IRQ-problems with the Un-Interruptible-Power-Supply.",
    "CPU-angle has to be adjusted because of vibrations coming from the nearby "
    "road.",
    ...
    "Internet exceeded (L)user level, please wait until a (l)user logs off "
    ...
    "(Do not turn off your computer, you do not want to cool down the Pentium "
    ...
    "the computers in the building or they shoot the sys-admin. Poor misguided "
    "fools.",
    ...
    "The math co-processor had an overflow error that leaked out and shorted "
    "the RAM.",
